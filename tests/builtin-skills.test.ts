...
import { EkkoDirectoryManager } from '../src/directories'
import { SkillListTool, SkillViewTool } from '../src/tools/skills'
...
describe('Ekko built-in skills', () => {
  ...
  it('ships only the selected built-in skill set and installs it into every profile', async () => {
    const bundledDirectory = resolve(process.cwd(), 'skills')
